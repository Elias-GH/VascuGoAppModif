...
public class Database1 extends SQLiteOpenHelper {
    ...
    private final static String DB_NAME = "steps1";
    ...
    private Database1(final Context context) {
        super(context, DB_NAME, null, DB_VERSION);
    }

    public static synchronized Database1 getInstance(final Context c) {
        if (instance == null) {
            instance = new Database1(c.getApplicationContext());
        }
...
public void truncatetable(){
    instance.getReadableDatabase().delete(DB_NAME, "1", null);
}
}
